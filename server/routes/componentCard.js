...
const{postData, fetchIdea, fetchComponent,insertComponent,insertDummyData,updateFrequency,fetchUserInfo,insertDummyUser,fetchComponentByIds}= require('../controllers/componentCardController');
